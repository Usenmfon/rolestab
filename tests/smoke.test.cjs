...
test('packaging config includes Windows, macOS, and Linux targets', () => {
  ...
  assert.equal(packageJson.build.nsis.installerIcon, 'public/android-chrome-512x512.png')
  assert.equal(packageJson.build.nsis.uninstallerIcon, 'public/android-chrome-512x512.png')

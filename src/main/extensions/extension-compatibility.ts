import type { ExtensionCompatibility, ExtensionManifest } from '../../shared/extensions.js'
...
export function determineExtensionCompatibility(manifest: ExtensionManifest): {

    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/35 px-4">
      ...
      >
        <div className="flex items-start gap-3">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-md bg-red-50 text-red-700">
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="h-9 rounded-md bg-red-700 px-3 text-sm font-semibold text-white hover:bg-red-800"
          >
            {confirmLabel}
          </button>
        </div>
